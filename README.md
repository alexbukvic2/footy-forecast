...
- **API contract:** OpenAPI 3.1 (`docs/openapi.yaml`), types generated by `oapi-codegen`
...
make generate # regenerate types from docs/openapi.yaml (run after spec changes)
```
