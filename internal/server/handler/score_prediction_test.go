...
func (f *fakeScorePredictionSvc) UpsertScore(ctx context.Context, in domain.UpsertScorePredictionInput) (*domain.ScorePrediction, error) {
...
func (f *fakeFixtureSvc) ListForUser(ctx context.Context, tournamentID, userID uuid.UUID) ([]*domain.UserFixtureView, error) {
	return f.listForUserFn(ctx, tournamentID, userID)
}

func (f *fakeFixtureSvc) ListForLeague(ctx context.Context, leagueID, userID uuid.UUID) ([]*domain.LeagueFixtureView, error) {
	return f.listForLeagueFn(ctx, leagueID, userID)
}

// ---------- helpers ----------

func putJSON(method, path string, body []byte) *http.Request {
...
func TestScorePrediction_UpsertScore_NegativeGoals(t *testing.T) {
	...
	fixtureID := uuid.New()
	svc := &fakeScorePredictionSvc{
		upsertFn: func(_ context.Context, _ domain.UpsertScorePredictionInput) (*domain.ScorePrediction, error) {
...
func TestFixture_ListForUser_HappyPath(t *testing.T) {
	...
	svc := &fakeFixtureSvc{
		listForUserFn: func(_ context.Context, tid, _ uuid.UUID) ([]*domain.UserFixtureView, error) {
...
func TestFixture_ListForLeague_HappyPath(t *testing.T) {
	...
	svc := &fakeFixtureSvc{
		listForLeagueFn: func(_ context.Context, lid, _ uuid.UUID) ([]*domain.LeagueFixtureView, error) {
